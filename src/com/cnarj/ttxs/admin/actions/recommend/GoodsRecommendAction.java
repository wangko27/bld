...
import com.cnarj.ttxs.util.RecommendArea;
...
public class GoodsRecommendAction extends PageAction{
    ...
    private Map<String,String> recommendAreaMap;
    ...
    public String recommend(){
        ...
        if("0".equals(goodsRecommend.getRecommendArea()) ){
            goodsRecommend.setRecommendState("0");
            goodsRecommend.setRecommendArea(null);
        }else {
   ...
   //根据日期获取是星期几
    ...
    public String find(){
        ...
        recommendAreaMap = RecommendArea.map;
        return SUCCESS;
    }
...
//        List<LocationInfo> locationInfoList = locationInfoService.getAllLocation();
    ...
    public Map<String, String> getRecommendAreaMap() {
        return recommendAreaMap;
    }

    public void setRecommendAreaMap(Map<String, String> recommendAreaMap) {
        this.recommendAreaMap = recommendAreaMap;
    }
}
