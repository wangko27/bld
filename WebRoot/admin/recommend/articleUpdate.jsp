...
<head>
    ...
    <%--<script type="text/javascript"src="<%=basePath%>admin/recommend/js/article.js"></script>--%>
            ...
            <td height="26" background="skin/images/newlinebg3.gif">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td >
                            ...
                            <script type="text/javascript">
                                ...
                                var typeSelect = document.getElementById("articleTypeSelect");
                                var op = typeSelect.options;
                    ...
                    <tr>
                        ...
                        <td><input name="article.orderList" id="orderList" value="${article.orderList}"/></td>
                    </tr>
