...
<table width="98%" border="0" cellpadding="2" cellspacing="1"
    ...
    <%--</tr>--%>
        <tr>
            <td >
                <span >
                <a href="<%=basePath%>admin/recommend/goodsRecommend.jsp" style="color: red">添加推荐商品</a>
                    </span>
            </td>
        </tr>
        ...
        <c:when test="${ ! empty result.content }">
           <c:forEach var="goodsRecommend" items="${result.content}">
               <tr     align="center" bgcolor="#FFFFFF"
                   ...
                   <td>
                       <u>
                            <c:if test="${goodsRecommend.recommendArea eq 'index_first_floor'}">首页1楼</c:if>
                           <c:if test="${goodsRecommend.recommendArea eq 'index_second_floor'}">首页2楼</c:if>
                           <c:if test="${goodsRecommend.recommendArea eq 'index_third_floor'}">首页3楼</c:if>
                       </u>
                   </td>
                   <td>
                       <u>
