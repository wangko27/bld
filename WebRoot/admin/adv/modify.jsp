							...
							<tr>
								...
								<td>
                                    ...
                                    <script type="text/javascript">
                                        var locationintro= '${info.locationInfo.locationintro}';
//                                        alert("locationintro="+locationintro+",type="+typeof locationintro)
                                        var locationSelect = document.getElementById("lAdd");
                                        var op = locationSelect.options;
                                        for(var i=0; i< op.length;i++){
//                                            alert("op[i].text="+op[i].text+",type="+typeof op[i].text);
                                            if(op[i].text === locationintro){
                                                op[i].selected = true;
                                            }
                                        }
                                    </script>
							...
							<tr>
								...
								<td>
									<input name="advInfo.showbegindate" type="text" class="Wdate" id="begindate"
										onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" size="30" maxlength="30" readonly="readonly" value="<fmt:formatDate value="${info.showbegindate }" pattern="yyyy-MM-dd HH:mm:ss"/>" />
                            ...
                            <tr>
                                ...
                                <td>
										...
										onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" size="30" value="<fmt:formatDate value="${info.showenddate }" pattern="yyyy-MM-dd  HH:mm:ss"/>" readonly="readonly" />
