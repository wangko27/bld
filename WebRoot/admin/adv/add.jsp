						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td>
									<input name="advInfo.showbegindate" type="text" class="Wdate" id="begindate"
										onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" size="30" maxlength="30" readonly="readonly" />
                            ...
                            <tr>
                                ...
                                <td>
										...
										onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" size="30" readonly="readonly" />
